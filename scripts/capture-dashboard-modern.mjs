...
async function capture() {
  ...
  await page.screenshot({ path: path.join(outDir, "01_superadmin_desktop_1440x900.png"), fullPage: false });
  ...
  await page.screenshot({ path: path.join(outDir, "04_superadmin_desktop_collapsed_rail.png"), fullPage: false });
  // Expand back
  ...
  await page.screenshot({ path: path.join(outDir, "02_superadmin_tablet_1024x768.png"), fullPage: false });

  // 4. Capture Mobile 390x844
  console.log("Capturing Mobile 390x844...");
  await page.setViewportSize({ width: 390, height: 844 });
  await page.waitForTimeout(500);
  await page.screenshot({ path: path.join(outDir, "03_superadmin_mobile_390x844.png"), fullPage: false });
  ...
  await page.screenshot({ path: path.join(outDir, "05_logout_confirmation_modal.png"), fullPage: false });
  ...
  await page.screenshot({ path: path.join(outDir, "06_sekolah_hero_card_desktop.png"), fullPage: false });

  // 7. Capture /sekolah Mobile
  console.log("Capturing /sekolah Mobile 390x844...");
  await page.setViewportSize({ width: 390, height: 844 });
  await page.waitForTimeout(600);
  await page.screenshot({ path: path.join(outDir, "08_sekolah_mobile_390x844.png"), fullPage: false });
  ...
  await page.waitForTimeout(600);
  await page.screenshot({ path: path.join(outDir, "09_school_profile_toast_success.png"), fullPage: false });
  ...
  await page.waitForTimeout(600);
  await page.screenshot({ path: path.join(outDir, "10_sekolah_unit_organisasi_desktop.png"), fullPage: false });
  ...
  await page.waitForTimeout(600);
  await page.screenshot({ path: path.join(outDir, "11_unit_organisasi_mobile.png"), fullPage: false });
  ...
  await page.waitForTimeout(600);
  await page.screenshot({ path: path.join(outDir, "12_sekolah_master_jabatan_desktop.png"), fullPage: false });
  ...
  await page.waitForTimeout(600);
  await page.screenshot({ path: path.join(outDir, "13_sekolah_master_jabatan_mobile.png"), fullPage: false });
  ...
  await page.waitForTimeout(600);
  await page.screenshot({ path: path.join(outDir, "14_sekolah_penugasan_personil_desktop.png"), fullPage: false });
  ...
  await page.waitForTimeout(600);
  await page.screenshot({ path: path.join(outDir, "15_sekolah_penugasan_personil_mobile.png"), fullPage: false });
